...
export const predictions: Prediction[] = [
  {
    ...
    title: 'Bitcoin Will Reach $100k By End Of Year',
    description:
      'With The Current Surge And Momentum, The Price Of Bitcoin Will Reach $100k. This Bull Run Is Just Starting And More Institutional Investors Are Coming.',
    category: 'Crypto',
    deadline: new Date('2024-12-31'),
    createdAt: new Date('2024-01-15'),
    authorId: '1',
  ...
  },
  {
    ...
    title: 'Tech Stocks Are Expected To Rally As Earnings Reports Come In Strong',
    description:
      'Major Tech Companies Will Report Strong Earnings This Quarter, Especially With The Upcoming Tech Innovations.',
    category: 'Trends',
    deadline: new Date('2024-08-31'),
    createdAt: new Date('2024-01-20'),
    authorId: '2',
  ...
  },
  {
    ...
    title: 'Housing Prices Are Likely To Stabilize After A Surge In 2023',
    description:
      'After A Significant Rise, The Housing Market Will Stabilize Due To Rising Interest Rates And Economic Factors.',
    category: 'Trends',
    deadline: new Date('2024-09-30'),
    createdAt: new Date('2024-01-25'),
    authorId: '3',
  ...
  },
  {
    ...
    title: 'New Healthcare Policies Could Reshape Patient Experience',
    description:
      'Upcoming Healthcare Policy Changes Will Enhance The Patient Experience Across The United States Medical System.',
    category: 'Healthcare',
    deadline: new Date('2024-10-31'),
    createdAt: new Date('2024-01-28'),
    authorId: '4',
...
// 🔹 Get all predictions (for static generation)
